...
function initScrollAnimations() {
    const animatedElements = document.querySelectorAll('.section-header, .hero-content, .about-content, .skill-item, .timeline-item, .project-card, .contact-content');
...
console.log(`
🚀 Resume Website Loaded Successfully!
